...
Agent! works with Claude API, Ollama Pro/Max Cloud, and local Ollama, vLLM, LMStudio. Local LLMs need 32-128GB RAM on Apple Silicon. For best results Large Cloud LLMs recommended.
