...
//
// INPUT: ~/Documents/Agent/send_message_input.json
// OUTPUT: ~/Documents/Agent/send_message_output.json
//
// JSON fields:
...
public func scriptMain() -> Int32 {
    ...
    let inputPath = "\(NSHomeDirectory())/Documents/Agent/send_message_input.json"
    let outputPath = "\(NSHomeDirectory())/Documents/Agent/send_message_output.json"
