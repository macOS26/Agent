...
final class ToolPreferencesService {
    ...
    static let toolGroups: [String: Set<String>] = [
        ...
        "File Manager": Set(["read_file", "write_file", "edit_file", "create_diff", "apply_diff", "undo_edit", "diff_and_apply", "list_files", "search_files", "read_dir", "file_manager"]),
        "Automation": Set(["applescript_tool", "accessibility", "javascript_tool", "xcode", "lookup_sdef"]),
    ...
    static let appleAIDefaults: Set<String> = [
        AgentTools.Name.executeAgentCommand, AgentTools.Name.readFile,
        AgentTools.Name.writeFile, AgentTools.Name.editFile,
