...
extension AccessibilityService {
    ...
    func findElementInApp(pid: pid_t, role: String?, title: String?, value: String?) -> AXUIElement? {
        let app = AXUIElementCreateApplication(pid)
        return findElementInHierarchy(app, role: role, title: title, value: value)
    }

    func findElementGlobally(role: String?, title: String?, value: String?) -> AXUIElement? {
