...
struct SystemPromptsView: View {
    ...
    private let providerLabels: [(APIProvider, String, Color, NSColor)] = [
        (.claude,          "Claude",   Color(red: 0.67, green: 0.52, blue: 0.3),  NSColor(red: 0.67, green: 0.52, blue: 0.3,  alpha: 1.0)),
        (.ollama,          "Ollama",   Color(red: 0.3,  green: 0.6,  blue: 0.55), NSColor(red: 0.3,  green: 0.6,  blue: 0.55, alpha: 1.0)),
        (.localOllama,     "Local",    Color(red: 0.45, green: 0.55, blue: 0.65), NSColor(red: 0.45, green: 0.55, blue: 0.65, alpha: 1.0)),
        (.foundationModel, "Apple AI", Color(red: 0.3,  green: 0.65, blue: 0.35), NSColor(red: 0.3,  green: 0.65, blue: 0.35, alpha: 1.0)),
    ]
    ...
    private func nsColor(for provider: APIProvider) -> NSColor {
        providerLabels.first { $0.0 == provider }?.3 ?? NSColor(red: 0.3, green: 0.65, blue: 0.35, alpha: 1.0)
    }
