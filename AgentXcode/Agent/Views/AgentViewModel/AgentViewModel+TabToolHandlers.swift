...
extension AgentViewModel {
    ...
    func handleTabToolCallBody(
        ...
        // File Manager
        case "read_file", "write_file", "edit_file", "create_diff", "apply_diff", "undo_edit", "diff_and_apply", "list_files", "search_files", "read_dir":
        ...
        // Shell
        case "execute_agent_command", "execute_daemon_command", "batch_commands":
