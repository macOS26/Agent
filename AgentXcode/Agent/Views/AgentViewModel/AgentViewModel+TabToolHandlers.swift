...
private let tabHandlerLog = Logger(subsystem: "Agent.app.toddbruss", category: "TabToolHandlers")
    ...
    func handleTabToolCallBody(
        ...
        if name == "task_complete" {
            ...
            if mediator.isEnabled && mediator.showAnnotationsToUser {
                tabHandlerLog.info("[\(tab.displayTitle)] Apple AI mediator: summarizing completion...")
