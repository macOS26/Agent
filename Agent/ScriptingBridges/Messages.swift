...
@objc public enum MessagesServiceType : AEKeyword {
    case sms = 0x73736d73 /* b'ssms' */
    case iMessage = 0x73696d73 /* b'sims' */
    case rcs = 0x73726373 /* b'srcs' */
}

// MARK: MessagesDirection
@objc public enum MessagesDirection : AEKeyword {
    case incoming = 0x46546963 /* b'FTic' */
    case outgoing = 0x46546f67 /* b'FTog' */
}

// MARK: MessagesTransferStatus
@objc public enum MessagesTransferStatus : AEKeyword {
    case preparing = 0x46547370 /* b'FTsp' */
    case waiting = 0x46547377 /* b'FTsw' */
    case transferring = 0x46547367 /* b'FTsg' */
    case finalizing = 0x4654737a /* b'FTsz' */
    case finished = 0x46547366 /* b'FTsf' */
    case failed = 0x46547365 /* b'FTse' */
}

// MARK: MessagesConnectionStatus
@objc public enum MessagesConnectionStatus : AEKeyword {
    case disconnecting = 0x64636e67 /* b'dcng' */
    case connected = 0x636f6e6e /* b'conn' */
    case connecting = 0x636f6e67 /* b'cong' */
    case disconnected = 0x64636f6e /* b'dcon' */
}
...
@objc public protocol MessagesAccount: SBObjectProtocol, MessagesGenericMethods {
    ...
    @objc optional func setEnabled(_ enabled: Bool) // Is the account enabled?
}
